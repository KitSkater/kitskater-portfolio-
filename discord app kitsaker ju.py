...
#fun commeds 
jokes = ["Why don't scientists trust atoms? Because they make up everything!","Why was the math book sad? It had too many problems.","Why can't you give Elsa a balloon? Because she will let it go!"]
...
async def meme(interaction: discord.Interaction):
    memes = ["https://i.imgur.com/j9pZCsK.jpg","https://i.imgur.com/w3duR07.png","https://i.imgur.com/yhFNOhU.jpg"]
...
gifs = ["https://media.giphy.com/media/3o6ZsYm5Gdm9TBH3O0/giphy.gif","https://media.giphy.com/media/l2QE6NSBqFGhJ8kn6/giphy.gif","https://media.giphy.com/media/xUPGcEliCc7bETyfO8/giphy.gif"]
...
roasts = ["You're like a cloud. When you disappear, it’s a beautiful day.","You're proof that even garbage can have opinions.","You bring everyone so much joy... when you leave the room."]
